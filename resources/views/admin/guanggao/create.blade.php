            ...
            <div class="tpl-form-body tpl-form-line">
                <form class="am-form tpl-form-line-form" action="/guanggao" method="post" enctype="multipart/form-data">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="name" class="tpl-form-input" id="user-name" placeholder="请填写广告名称">
                            <small></small>
                        </div>
                    </div>
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="site" class="tpl-form-input" id="user-name" placeholder="请输入有效跳转连接地址">
                            <small></small>
                        </div>
                    </div>
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="jieshao" class="tpl-form-input" id="user-name" placeholder="给广告备注个详情介绍">
                            <small></small>
                        </div>
                    </div>
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="file" name="image" class="tpl-form-input" id="user-name" ">
                            <small></small>
                        </div>
                    </div>
                    <div class="am-form-group ">
