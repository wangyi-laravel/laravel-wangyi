                    ...
                    <table class="am-table am-table-striped am-table-hover table-main">
                        <thead>
                            <tr>
                                ...
                                <th class="table-set">网址</th>
                                <th class="table-set">图片</th>
                                <th class="table-set">广告介绍</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="am-hide-sm-only">{{$v['jieshao']}}</td>
                                <td class="am-hide-sm-only">{{$v['created_at']}}</td>
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a style="float:left" href="/guanggao/{{$v['id']}}/edit" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                </form>
