                ...
                <div class="header-right animated wow fadeInRight animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInRight;">
                    <div class="header-right1">
                        ...
                        <i class="glyphicon glyphicon-book"></i>
                            <ul class="navigation">
                                <li style="position:absolute;top:0px;"><a href="#">Main Cat 2  </a>
                                    <ul id="weidong">
                    ...
                    <div class="header-right2">
                        <div class="cart box_1">
                            <a href="checkout.html">
                                <h3> <div class="total">
                                <span class="simpleCart_total">shopping cart</span> (<span id="simpleCart_quantity" class="simpleCart_quantity">0</span> items)</div>
